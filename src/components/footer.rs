...
pub fn Footer() -> impl IntoView {
    let current_year = 2025; // You can make this dynamic if you want
            ...
            <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-zinc-400">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex gap-4">
                        // GITHUB
                        <a href="https://github.com/yourusername" target="_blank" class="text-zinc-400 hover:text-white hover:scale-110 transition-transform">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 4 1.5l2.5 2.5c1 .25 2 .5 2.5.5s1.5-.25 2.5-.5a8.6 8.6 0 0 1 2.5 2.5c-2 1.5-2 3.5 0 3.5-.73 1.02-1.08 2.25-1 3.5 0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
                        </a>
                        
                        // LINKEDIN
                        <a href="https://linkedin.com/in/yourusername" target="_blank" class="text-zinc-400 hover:text-blue-400 hover:scale-110 transition-transform">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
                        </a>

                        // EMAIL
                        <a href="mailto:your@email.com" class="text-zinc-400 hover:text-orange-500 hover:scale-110 transition-transform">
                ...
                <div class="flex flex-col gap-4">
                    <h3 class="text-xs font-bold text-zinc-500 uppercase tracking-widest">"// Powered_By"</h3>
